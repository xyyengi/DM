...
def build_summary_row(
    ...
    row = {
        ...
        "coverage": metric_first(metrics, ["coverage", "total_coverage_100%", "total_coverage_90%"]),
        "interval_width": metric_first(metrics, ["interval_width", "total_width_100%", "total_width_90%"]),
