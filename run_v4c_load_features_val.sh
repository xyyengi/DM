...
CONFIG=${CONFIG:-configs/v4c_load_ramp1_netload_no_guidance_168h.yaml}
EXP_NAME=${EXP_NAME:-v4c_load_ramp1_netload_no_guidance_168h}
EPOCHS=${EPOCHS:-150}
...
if [[ -z "${run_id}" ]]; then
  echo "Could not locate the new V4-C load-feature run" >&2
  exit 1
fi
